...
**Сборщики (bundlers)** - это инструменты, которые автоматизируют процесс подготовки фронтенд-приложений к production. Они анализируют зависимости между модулями, объединяют их в оптимизированные файлы (бандлы) и применяют заданные оптимизации. 
