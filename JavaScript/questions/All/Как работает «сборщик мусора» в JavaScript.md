...
На этапе маркировки алгоритм начинает с корневых объектов, таких как глобальные объекты и объекты в стеке вызовов, и рекурсивно проходит по всем ссылкам, помечая все достижимые объекты. Достижимые объекты - это объекты, к которым можно добраться через цепочку ссылок, начиная с корневых объектов.
