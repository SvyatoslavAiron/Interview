...
JavaScript использует механизм прототипного наследования, а это значит, что если свойство или метод не найден в текущем объекте, то поиск будет осуществляться дальше по цепочке прототипов.
