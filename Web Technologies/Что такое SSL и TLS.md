...
7. Клиент и сервер отправляют друг другу зашифрованное сообщение Finished, содержащее зашифрованные HMAC-хеши всех предыдущих сообщений, чтобы убедиться, что Handshake не был подменен, и если всё хорошо, то
8. Handshake завершается, устанавливается защищенный канал и все данные передаются в зашифрованном виде с использованием симметричных ключей.
