...
- Код по требованию (опционально) — дополнительное ограничение, позволяющее серверам предоставлять логику приложения для выполнения определённых действий с ресурсами.